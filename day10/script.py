...
def find_paths(grid, x, y, current_value, visited, endpoints):
    ...
    paths = (
        find_paths(grid, x + 1, y, grid[x][y], visited, endpoints)  # South
        + find_paths(grid, x - 1, y, grid[x][y], visited, endpoints)  # North
        + find_paths(grid, x, y + 1, grid[x][y], visited, endpoints)  # East
        + find_paths(grid, x, y - 1, grid[x][y], visited, endpoints)  # West
    )
